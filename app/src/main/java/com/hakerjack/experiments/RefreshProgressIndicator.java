...
class RefreshProgressSpinner extends Drawable implements Animatable {
    ...
    public RefreshProgressSpinner(Context context, View parent) {
        mParent = parent;
     ...
     *
     * @param size One of {@link RefreshProgressSpinner.LARGE} or
     *            {@link RefreshProgressSpinner.DEFAULT}
     */
